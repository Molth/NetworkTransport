...
namespace kcp
{
    ...
    public static unsafe class KCP_INTERFACE
    {
        ...
        public static IKCPCB* ikcp_create(IKCPCB* kcp, void* user) => KCP.ikcp_create(kcp, user);
        ...
        public static void ikcp_update(IKCPCB* kcp, uint current, byte* buffer) => KCP.ikcp_update(kcp, current, buffer);
        ...
        // flush pending data
        public static void ikcp_flush(IKCPCB* kcp, byte* buffer) => KCP.ikcp_flush(kcp, buffer);
